...
const Searchbar = () => {
  return (
    <div className="flex w-full h-15 rounded-2xl  bg-white shadow-md my-3 relative">
        <input type="text" name="" id="" placeholder="what do you want to cook today?" className="w-full border-none outline-none ps-10 text-xl text-black/50 tracking-tighter"/>
